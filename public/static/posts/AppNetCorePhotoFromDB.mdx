---
title: 'Cargar imagen guardada en la base de datos con ASP.NET Core Razor Pages'
tags: ["ASP.NET Core","Imagen en la base de datos"]
desc: 'Cargar imagen guardada en la base de datos con ASP.NET Core Razor Pages'
date: '2022-01-29'
image: '/static/images/netcoreRazor.png'
---
# Cargar imagen guardada en la base de datos con ASP.NET Core Razor Pages
